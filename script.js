...
function checkout(){
  ...
  alert("DEMONSTRAÇÃO\\n\\nPedido que seria enviado pelo WhatsApp:\\n\\n"+lines+"\\n\\nO número real da Avipet Santa Rosa será configurado depois.");
}
function requestService(service){
  alert(`DEMONSTRAÇÃO\\n\\nAqui o cliente poderia solicitar informações/agendar ${service} diretamente pelo WhatsApp da Avipet Santa Rosa.`);
}
function showContact(){
  alert("DEMONSTRAÇÃO\\n\\nAqui entram endereço, horário e WhatsApp reais da Avipet Santa Rosa após confirmação com o proprietário.");
}
